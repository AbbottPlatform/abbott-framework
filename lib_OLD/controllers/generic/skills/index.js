module.exports = function (abbottController) {
  ...
  if ((abbottController.hearsMessageEvents) && (abbottController.hearsMessageEvents.length > 0)) {
    abbottController.hears(['^uptime$', '^debug$'], abbottController.hearsMessageEvents.join(','), function (bot, message) {
      //TODO: Add message pre-process midlewares 
    ...
    abbottController.hears('.*', abbottController.hearsTriggerEvents, function (bot, message) {
      //TODO: Add message pre-process midlewares 
    ...
    abbottController.hears('.+', abbottController.hearsMessageEvents, function (bot, message) {
      //TODO: Add message pre-process midlewares 
      if (abbottController.nlpProcessor) {
